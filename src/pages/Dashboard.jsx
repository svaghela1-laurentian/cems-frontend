    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-blue-200 flex flex-col items-center p-6">
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-2 w-full max-w-3xl">
        <div className="bg-white p-4 rounded shadow text-center">
          ...
          <Link to="/events" className="text-3xl text-blue-600 hover:underline">12</Link>
        </div>
        <div className="bg-white p-4 rounded shadow text-center">
      ...
      <div className="mt-6 space-y-4">
        {role === "student" && (
          <>
            <Link
              ...
              className="bg-white p-3 rounded shadow hover:shadow-lg block"
            >
              My Events
            </Link>
            <Link
        ...
        <Link to="/profile" className="bg-white p-3 rounded shadow hover:shadow-lg block">My Profile</Link>
      </div>
    </div>
  );
};
